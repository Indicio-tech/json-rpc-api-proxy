...
exports.JsonRpcApiProxy = void 0;
...
const exceptionMiddleware = async (next, request, serverParams) => {
    try {
        ...
        return (0, json_rpc_2_0_1.createJSONRPCErrorResponse)(request.id ?? null, -32000, 'Internal server error', errorMessage);
    }
};
/**
...
class JsonRpcApiProxy {
    ...
    constructor(transport) {
        ...
        this.rpc = new json_rpc_2_0_1.JSONRPCServerAndClient(new json_rpc_2_0_1.JSONRPCServer(), new json_rpc_2_0_1.JSONRPCClient(request => {
...
exports.JsonRpcApiProxy = JsonRpcApiProxy;
